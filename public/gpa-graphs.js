   ...
   // getSATMidpointResults();
    ...
    $('#univOption').change(function() {
       ...
       // console.log(filterCriteriaByUniv);
        ...
        getSATMidpointResults1(filterCriteriaByUniv);
...
function drawGraphForSATAVG() {
    $.ajax({
        ...
        success: function(results) {
            ...
            console.log("in drawGraphForSATAVG");
            let datas = [];
...
function getSATMidpointResults(filterValue) {
    ...
    $.ajax({
        ...
        success: function(results) {
            ...
            console.log("in getSATMidpointResults");
            let datas = [];
            results
                .filter(
    ...
    $.ajax({
        ...
        success: function(results) {
            ...
            for(var i=0;i<results.length;i++){
                ...
                var l=[]
                var d={'y':parseFloat(results[i]['SAT_AVG']),'x':parseFloat(results[i]['GPA_Val'])}
